                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                <img src="${furn.picture}" alt="Product"/>
                                                <img class="hover-image" src="${furn.picture}"
                                                     alt="Product"/>
                                            </a>
                                            <span class="badges">
...
<div class="pro-pagination-style text-center mb-md-30px mb-lm-30px mt-6" data-aos="fade-up">
    <ul>
        ...
        <li><a href="customerFurnServlet?action=page&pageNo=${requestScope.page.totalPages}">末页</a></li>
